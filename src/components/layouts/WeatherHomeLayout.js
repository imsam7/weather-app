...
function WeatherHomeLayout({ forecastDetails }) {
    ...
    return (
        <>
                        ...
                        <div className="central">
                            <div className="alignright ">
                                <div className="">
                                    ...
                                    {selectedWeatherForecast[0].weather[0].main === 'Rain' && <img className="cloud-icon" />}
                                </div>
                            </div>
                            <div className="alignleft">
                                ...
                                <div className="desktopNone"><span className="heading">Chance of rain:</span>&nbsp;<span className="text">{selectedWeatherForecast[0].pop}%</span></div>
                                <div className="desktopNone"><span className="heading">Cloudiness:</span>&nbsp;<span className="text">{selectedWeatherForecast[0].clouds.all}%</span></div>
                                {/* <div><b>Visibility</b>&nbsp;{selectedWeatherForecast[0].visibility} m</div> */}
                                <div className="mobileNone"><span className="heading">Sunrise:</span>&nbsp;<span className="text">{sunriseTime}</span></div>
                                <div className="mobileNone"><span className="heading">Sunset:</span>&nbsp;<span className="text">{sunsetTime}</span></div>
                            </div> <br />
                        </div>
            ...
            <div className="flexedCenter">
                <div class="sunmoon">
                    <div class="sun-times">
                        <div class="sun-path">
                            <div class="sun-times sun-animation"></div>
                        </div>
                        <div class="sun-symbol-path"><span class="sun-icon-graph"></span></div>
                    </div>
                    <div class="markers">
                        <div class="sunrise">{sunriseTime}</div>
                        <div class="sunset">{sunsetTime}</div>
                    </div>
                    <div class="clear">&nbsp;</div>
                </div>
            </div>
